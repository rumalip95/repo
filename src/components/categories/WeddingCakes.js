...
import {weddingCakeData} from './WeddingCakeData';
...
class WeddingCakes extends Component {
    ...
    cakeRenderedArray = weddingCakeData.map(ele => {
        return(
            <CategoryCard
                key = {ele.id}
                title={ele.title}
        ...
        <li id="searchBar">
          <form className="navbar-form navbar-left" action="/action_page.php">
            <div className="input-group" style={{width:"500px",paddingBottom:"20px"}}>
              <input type="text" class="form-control" placeholder="Search Wedding Cakes" name="search"/>
